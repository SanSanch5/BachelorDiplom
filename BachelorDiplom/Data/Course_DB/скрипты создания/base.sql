...
/****** Object:  Database [Course_DB]    Script Date: 03/29/2014 10:57:55 ******/
CREATE DATABASE [Course_DB] ON  PRIMARY 
( NAME = N'Course_DB', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL10.SQLEXPRESS\MSSQL\DATA\Course_DB.mdf' , SIZE = 3072KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'Course_DB_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL10.SQLEXPRESS\MSSQL\DATA\Course_DB_log.ldf' , SIZE = 1024KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO

ALTER DATABASE [Course_DB] SET COMPATIBILITY_LEVEL = 100
GO
...
ALTER DATABASE [Course_DB] SET AUTO_CREATE_STATISTICS ON 
GO
...
ALTER DATABASE [Course_DB] SET RECOVERY SIMPLE 
GO
